...
public class MainActivity extends AppCompatActivity {
  ...
  private static final String LABEL_TO_FORMAT = "pair_%d_label";
  private static final String COUNT_TO_FORMAT = "pair_%d_count";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    for (int i = minPairValue; i<= maxPairValue; i++) {
      String labelIdString = String.format(LABEL_TO_FORMAT, i);
      ...
      String countIdString = String.format(COUNT_TO_FORMAT, i);
